...
//Suitable for memory-constrained environments where integers aretoolarge
...
//float is used for numbers with decimals, with precision up to 7decimaldigits
...
//double is used for numbers with decimal, with precision up to 15decimaldigits
